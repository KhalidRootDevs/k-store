  ...
  return (
    <div className="border rounded-md">
      <div className="flex flex-wrap gap-1 p-2 border-b bg-muted/50">
        ...
        <div className="w-px h-8 bg-border mx-1" />
        <Button variant="ghost" size="icon" className="h-8 w-8" onClick={handleLink} title="Insert Link">
          <Link className="h-4 w-4" />
        </Button>
        <Button variant="ghost" size="icon" className="h-8 w-8" onClick={handleImage} title="Insert Image">
      ...
      <div
        ref={editorRef}
        className={`min-h-[300px] p-4 focus:outline-none prose max-w-none ${isFocused ? "ring-1 ring-ring" : ""}`}
        contentEditable
