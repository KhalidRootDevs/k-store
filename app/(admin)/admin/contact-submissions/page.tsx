...
export default function ContactSubmissionsPage() {
  ...
  const handleViewSubmission = (submission: ContactSubmission) => {
    ...
    if (submission.status === "new") {
      const updatedSubmissions = submissions.map((s) => (s.id === submission.id ? { ...s, status: "read" } : s))
  ...
  const handleUpdateStatus = (id: number, status: "new" | "read" | "replied" | "archived") => {
    const updatedSubmissions = submissions.map((s) => (s.id === id ? { ...s, status } : s))
    setSubmissions(updatedSubmissions)
    localStorage.setItem("contactSubmissions", JSON.stringify(updatedSubmissions))
    ...
    <Container>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">View and manage customer inquiries from the contact form.</p>
        </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleUpdateStatus(selectedSubmission.id, value as "new" | "read" | "replied" | "archived")
                    }
                  >
              ...
              <div className="flex justify-between pt-4">
                ...
                <Button
                  onClick={() => {
                    ...
                    toast({
                      title: "Reply sent",
                      description: "In a real application, this would open an email interface.",
                    })
                  }}
                >
                  Reply
