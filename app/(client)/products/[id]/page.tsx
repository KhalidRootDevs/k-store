...
export default function ProductPage({ params }: { params: { id: string } }) {
  ...
  const areAllVariantsSelected = () => {
    ...
    return product.variants.every((variant) => selectedOptions[variant.name]);
  };
            ...
            {product.variants?.map((variant, index) => (
              <div key={index}>
                ...
                <div className="flex flex-wrap gap-2">
                  {variant.options.split(",").map((option) => (
                    <Button
                      key={option.trim()}
                      variant={
                        selectedOptions[variant.name] === option.trim()
                          ? "default"
                          : "outline"
                      }
                      className="h-10 px-4"
                      onClick={() =>
                        handleVariantSelect(variant.name, option.trim())
                      }
                    >
                      {option.trim()}
                    </Button>
...
//   price: 29.99,
//   discount: 0,
//   description: "A premium quality t-shirt made from 100% organic cotton. Comfortable, durable, and stylish.",
//   longDescription: `
// <p>Our Premium T-Shirt is designed for comfort and durability. Made from 100% organic cotton, it's soft on your skin and environmentally friendly.</p>
// <p>Features:</p>
// <ul>
...
// </ul>
// <p>Care Instructions: Machine wash cold with like colors. Tumble dry low. Do not bleach.</p>
// `,
//   images: [
...
//     { id: 2, name: "Color", options: ["Black", "White", "Blue", "Red"] },
//   ],
//   reviews: [
//     {
//       id: 1,
//       user: "John D.",
//       rating: 5,
//       comment: "Great quality t-shirt. Fits perfectly and the material is very comfortable.",
//       date: "2023-05-15",
//     },
//     {
//       id: 2,
//       user: "Sarah M.",
//       rating: 4,
//       comment: "Nice shirt, good quality. Runs a bit large though.",
//       date: "2023-04-22",
//     },
//     {
//       id: 3,
//       user: "Michael P.",
//       rating: 5,
//       comment: "Excellent product. This is my third one!",
//       date: "2023-03-10",
//     },
//   ],
//   inStock: true,
...
// // Add this after the existing product mock data
...
//   useEffect(() => {
//     // Use the product ID from params to prevent issues with mock data
//     const productId = Number.parseInt(params.id)

//     // Only add to recently viewed if we have a valid product ID
//     if (!isNaN(productId)) {
//       addToRecentlyViewed({
//         id: productId,
//         name: product.name,
...
//     // Remove addToRecentlyViewed from dependencies
...
//           >
//             <div
//               className={`absolute inset-0 transition-transform duration-200 ${isZoomed ? "scale-150" : "scale-100"}`}
...
//                     <Button
//                       key={option}
//                       variant={selectedOptions[variant.name] === option ? "default" : "outline"}
//                       className="h-10 px-4"
...
//             <p className="font-medium">Availability: {product.inStock ? "In Stock" : "Out of Stock"}</p>
//             <p>Free shipping on orders over $50</p>
//             <p>30-day return policy</p>
//           </div>
//         </div>
...
//               <h3 className="text-lg font-semibold">Shipping Policy</h3>
//               <p className="mt-2">
//                 We offer free standard shipping on all orders over $50. Orders under $50 will be charged a flat rate of
//                 $5.99 for shipping. Standard shipping typically takes 3-5 business days. Express shipping is available
...
//                 Return shipping is free for defective items. For non-defective items, a return shipping fee may apply.
//               </p>
//             </div>
//           </div>
//         </TabsContent>
