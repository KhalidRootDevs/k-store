    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Get notified about sales, offers, and promotions</p>
              </div>
            </div>
            <Switch
              id="promotional"
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Receive updates about your order status and shipping</p>
              </div>
            </div>
            <Switch
              id="orderUpdates"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Stay updated about products you care about</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-start gap-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Get alerts when prices drop on products you viewed</p>
              </div>
            </div>
            <Switch id="priceDrops" checked={settings.priceDrops} onCheckedChange={() => handleToggle("priceDrops")} />
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Notifications about items in your wishlist (stock, price changes)
                </p>
              </div>
            </div>
            <Switch
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Receive text messages for important updates</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Receive text messages for order updates and delivery notifications
                </p>
              </div>
            </div>
            <Switch
