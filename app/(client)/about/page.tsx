...
const defaultAboutContent = {
  ...
  mainContent: `
    ...
    <h2>Our Story</h2>
    <p>OneVendor was founded with a simple mission: to make online shopping easy, enjoyable, and accessible to everyone. What started as a small venture has now grown into a comprehensive e-commerce platform offering thousands of products across multiple categories.</p>
    
    <h2>Our Values</h2>
    <p>At OneVendor, we believe in:</p>
    <ul>
    ...
    <h2>Our Team</h2>
    <p>Behind OneVendor is a dedicated team of professionals passionate about e-commerce and customer service. From our product specialists to our customer support representatives, everyone works together to ensure you have the best shopping experience.</p>
